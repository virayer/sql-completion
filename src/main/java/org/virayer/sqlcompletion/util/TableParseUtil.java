...
//                    2019-09-08 yj 添加是否下划线转换为驼峰的判断
                    ...
                    if (columnLine.contains(" int") || columnLine.contains("smallint")) {
                        ...
                        if (startKh >= 0) {
                            ...
                            if ((fanwei.length > 1 && "0".equals(fanwei[1])) || fanwei.length == 1) {
                                ...
                                fieldTable = BigDecimal.class.getSimpleName();
                            }
                        } else {
                            fieldClass = BigDecimal.class.getSimpleName();
                            fieldTable = BigDecimal.class.getSimpleName();
                        ...
                        fieldTable = Boolean.class.getSimpleName();
                    } else {
                        fieldClass = String.class.getSimpleName();
                        fieldTable = String.class.getSimpleName();
                    }
                    ...
                    fieldInfo.setFieldTable(fieldTable);
